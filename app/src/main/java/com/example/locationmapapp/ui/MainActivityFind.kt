...
internal fun MainActivity.showFindDialog() {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showFindResults(
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showFavoritesResults(dialog: android.app.Dialog) {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
    val center = binding.mapView.mapCenter
...
internal fun MainActivity.poiCategoryColor(categoryTag: String): Int {
    return PoiCategories.ALL.firstOrNull { it.tags.contains(categoryTag) }?.color
        ?: Color.parseColor("#757575")
}

@SuppressLint("SetJavaScriptEnabled")
internal fun MainActivity.showPoiDetailDialog(result: com.example.locationmapapp.data.model.FindResult) {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
...
@SuppressLint("SetJavaScriptEnabled")
internal fun MainActivity.showFullScreenWebView(url: String, title: String) {
    val dialog = android.app.Dialog(this, android.R.style.Theme_Black_NoTitleBar_Fullscreen)
    dialog.requestWindowFeature(android.view.Window.FEATURE_NO_TITLE)
...
internal fun MainActivity.distanceBetween(from: GeoPoint?, to: GeoPoint): Float {
...
internal fun MainActivity.formatDistanceDirection(fromLat: Double, fromLon: Double, toLat: Double, toLon: Double): String {
    val results = FloatArray(2)
...
internal fun MainActivity.bearingToCardinal(bearing: Float): String {
...
internal fun MainActivity.enterFindFilterMode(tags: List<String>, label: String) {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showFindFilterBanner(label: String) {
...
internal fun MainActivity.removeFindFilterBanner() {
...
internal fun MainActivity.exitFindFilterMode() {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.enterFilterAndMapMode(results: List<com.example.locationmapapp.data.model.FindResult>, label: String) {
...
internal fun MainActivity.exitFilterAndMapMode() {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showGoToLocationDialog() {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
 ...
 */
internal fun MainActivity.goToLocation(point: GeoPoint, label: String) {
