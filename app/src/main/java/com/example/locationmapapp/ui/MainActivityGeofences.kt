...
internal fun MainActivity.loadGeofenceZonesForVisibleArea() {
    val prefs = getSharedPreferences("app_bar_menu_prefs", Context.MODE_PRIVATE)
    val bb = binding.mapView.boundingBox
...
internal fun MainActivity.renderTfrOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderCameraOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderSchoolOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderFloodOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderCrossingOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderDatabaseOverlays(zones: List<com.example.locationmapapp.data.model.TfrZone>) {
...
internal fun MainActivity.renderZoneOverlays(
...
internal fun MainActivity.buildZonePolygon(
...
internal fun MainActivity.clearOverlayList(list: MutableList<org.osmdroid.views.overlay.Polygon>) {
    for (overlay in list) {
...
internal fun MainActivity.clearTfrOverlays() = clearOverlayList(tfrOverlays)
internal fun MainActivity.clearCameraOverlays() = clearOverlayList(cameraOverlays)
internal fun MainActivity.clearSchoolOverlays() = clearOverlayList(schoolOverlays)
internal fun MainActivity.clearFloodOverlays() = clearOverlayList(floodOverlays)
internal fun MainActivity.clearCrossingOverlays() = clearOverlayList(crossingOverlays)
internal fun MainActivity.clearDatabaseOverlays() = clearOverlayList(databaseOverlays)

internal fun MainActivity.clearAllGeofenceOverlays() {
...
internal fun MainActivity.showDatabaseManagerDialog() {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.buildDatabaseCard(
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showCsvImportConfigDialog(uri: Uri) {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
...
internal fun MainActivity.showOverwriteConfirmationDialog(id: String, name: String) {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showZoneDetailDialog(zone: com.example.locationmapapp.data.model.TfrZone) {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
...
internal fun MainActivity.showTfrDetailDialog(zone: com.example.locationmapapp.data.model.TfrZone) = showZoneDetailDialog(zone)

/** Update alerts icon color based on alert severity. */
internal fun MainActivity.updateAlertsIcon(alerts: List<com.example.locationmapapp.data.model.GeofenceAlert>) {
...
@SuppressLint("SetTextI18n")
internal fun MainActivity.showGeofenceAlertBanner(alert: com.example.locationmapapp.data.model.GeofenceAlert) {
...
internal fun MainActivity.showWebcamPreviewDialog(webcam: com.example.locationmapapp.data.model.Webcam) {
    val density = resources.displayMetrics.density
    val dp = { v: Int -> (v * density).toInt() }
