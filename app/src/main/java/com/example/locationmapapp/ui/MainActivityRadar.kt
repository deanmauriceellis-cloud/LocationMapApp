...
internal fun MainActivity.addRadarOverlay() {
    try {
...
internal fun MainActivity.buildDarkTileSource(): org.osmdroid.tileprovider.tilesource.XYTileSource {
...
internal fun MainActivity.refreshRadarOverlay() {
    if (radarTileOverlay != null) {
        binding.mapView.overlays.remove(radarTileOverlay); radarTileOverlay = null
        addRadarOverlay()
...
internal fun MainActivity.generateRadarTimestamps(count: Int): List<String> {
...
internal fun MainActivity.startRadarAnimation() {
...
internal fun MainActivity.stopRadarAnimation() {
    if (!radarAnimating) return
