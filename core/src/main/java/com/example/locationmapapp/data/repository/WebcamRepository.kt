...
@Suppress("unused")
private const val MODULE_ID = "(C) Destructive AI Gurus, LLC, 2026 - Module WebcamRepository.kt"
...
class WebcamRepository @Inject constructor() {
    ...
    suspend fun fetchWebcams(
        ...
        val url = "http://10.0.0.229:4300/webcams?s=$south&w=$west&n=$north&e=$east&categories=$categories"
