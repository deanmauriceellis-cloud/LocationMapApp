...
@Suppress("unused")
private const val MODULE_ID = "(C) Destructive AI Gurus, LLC, 2026 - Module MainActivityWeather.kt"
 ...
 */
internal fun SalemMainActivity.updateWeatherToolbarIcon(data: com.example.locationmapapp.data.model.WeatherData?) {
    if (data == null) return
...
internal fun SalemMainActivity.showWeatherDialog() {
...
@SuppressLint("SetTextI18n")
internal fun SalemMainActivity.buildWeatherDialogContent(
    root: LinearLayout,
