...
@Suppress("unused")
private const val MODULE_ID = "(C) Destructive AI Gurus, LLC, 2026 - Module TcpLogStreamer.kt"
 ...
 * Call start() once from SalemMainActivity onCreate().
 *
...
object TcpLogStreamer {
    ...
    private const val HOST = "10.0.0.194"
