...
@Suppress("unused")
private const val MODULE_ID = "(C) Destructive AI Gurus, LLC, 2026 - Module DebugHttpServer.kt"
 ...
 * non-HTTP callers (e.g. `endpoints?.cancelWalkAndJoin()` from
 * `SalemMainActivity` and `SalemMainActivityDirections`) keep working.
 */
