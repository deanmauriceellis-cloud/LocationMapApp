...
- **S213 TTS field listen-test on Lenovo** (carry-forward) — confirm abbreviation expansion + markdown strip in real listening.
- **S215 visual edge-highlight tick** (S214 Phase-2 polish, low priority).
