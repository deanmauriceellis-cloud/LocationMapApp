...
## TOP PRIORITY — Next Session (S197)
...
0d. **(S195 carry-forward, still open) `civic_flag_mismatch` lint relaxation.** Currently reports 179 false positives because S195 flipped WORSHIP/EDUCATION/PARKS_REC to is_civic_poi=true intentionally. Either accept those as canonical or relax the lint to admit those categories alongside CIVIC.
