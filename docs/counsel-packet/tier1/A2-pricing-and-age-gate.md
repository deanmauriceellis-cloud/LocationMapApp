<a name="a2-pricing-and-age-gate"></a>

# A2. Pricing ($19.99 flat paid) + Age-Gate Posture for V1

**Prepared for:** 2026-04-20 counsel engagement meeting.

---

<a name="a2-1-operator-question"></a>

## 1. Operator's original question

> *"I need to know everything about how to place an application for commercial use on Google. I want to make any user spend $19.99 to buy it and I want to avoid the crazy new validations we have to do on age. I figure if I make people on Google pay $19.99 for the application — Google will do the new age requirement nonsense."*
...
<a name="a2-2-pricing-decision"></a>
...
The purchase unlocks the full app — all five bundled tours, all ~1,830 points of interest, the Witch Trials historical content (Oracle newspaper, portraits, cross-linked NPC narratives), the walking-directions engine, the GPS narration system, and the on-device map tile cache. Once purchased and installed, the app works fully offline.

### 2.2 Why flat paid and not tiered

The pre-decision plan was a four-tier pricing model (Free/ads, $4.99 Explorer, $9.99 Premium, $49.99/mo Salem LLM subscription). Operator pivoted to flat $19.99 at operator Session 138 for four reasons:
...
4. **$19.99 is a plausible one-time price for a Salem tour app.** Operator product judgment: visitors spending $400 on flights and hotels to walk Salem at Halloween will pay $19.99 for a guided-tour app. A $4.99 price signals disposable; a $19.99 price signals sit-down dinner.
...
There is no monthly platform fee, no upfront listing fee, no per-download charge. The one-time developer-account registration is $25.
...
**Consequence for the Privacy Policy:** V1 Posture A can honestly state *"We do not collect payment information — Google handles billing entirely"* (see [§A3](#a3-privacy-policy-v1) §2.3 and §2.5). This is one of the reasons V1 lands in a clean privacy posture.
...
The V1 posture makes all three signals clean:
...
- **In the Privacy Policy:**
  - V1 Posture A already handles this — see [§A3](#a3-privacy-policy-v1) §2.6 ("Children").
...
- [ ] Confirm the C-corp to be formed will be the Google Play merchant account holder.
...
- [ ] The Data Safety form answers will all be **None** for V1 (see [§A5](#a5-data-safety-answers)).

---

<a name="a2-5-summary"></a>
...
[Back to top](#cover) | [Privacy Policy V1 →](#a3-privacy-policy-v1)
